...
public class GenericTest {
	...
	@BeforeClass
	public static void excel_read() throws Exception{
		Workbook wb=WorkbookFactory.create(new FileInputStream(new File("C:/Temp/Selenium/input.xlsx")));
		...
		for  ( int i =1 ; i < rowNum ; i++) {
			 Row row = ws.getRow(i) ;
				for ( int j = 0 ; j <2 ; j++) {
					 ...
					 user_input1 = cell.getStringCellValue();
					System.out.print(user_input1 );
					j++;
					 cell = row.getCell(j) ;
					 user_input2 = cell.getStringCellValue();
  ...
  public void openSAP() throws InterruptedException {
	...
	public void enterUserName() throws InterruptedException  {
		 driver.findElement(By.id("txtUsername-inner")).sendKeys(user_input1);
		 System.out.println("User name entered...");
		 Thread.sleep(3000);
	 }
	@Test(priority=3)
	public void enterPassword() throws InterruptedException {
		 driver.findElement(By.id("txtPassword-inner")).sendKeys(user_input2);
